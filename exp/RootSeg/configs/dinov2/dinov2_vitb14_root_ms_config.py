...
custom_imports = dict(imports=['exp.RootSeg.mmseg_custom.models.backbones.vit_dinov2', 
                'exp.RootSeg.mmseg_custom.models.decode_heads.bn_head',
                'exp.RootSeg.mmseg_custom.datasets.root_system'], 
                allow_failed_imports=False)

# 训练基础参数
# DINOv2-Base 预训练权重路径 - 请根据实际情况修改
checkpoint = 'exp/RootSeg/pretrain/dinov2_vitb14_pretrain.pth'  # TODO: 修改为实际路径
crop_size = (1022, 1022)
max_iters = 10000
val_interval = 500
log_interval = 20
...
# 性能与硬件相关
batch_size = 8  # DINOv2-Base 显存占用适中，可以使用较大的 batch size
num_workers = 8
...
#             register_tokens=dict(decay_mult=0.0),
#             norm=dict(decay_mult=0.0),
#             # Decode head 使用更大的学习率
...
# 断点保存与工作目录
# work_dir = 'exp/root_seg/work_dirs/segformer_dinov2-base_1xb4-20k_root-1024x1024'
